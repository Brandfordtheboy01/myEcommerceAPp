...
import { vendorRecentOrdersColumns } from "./vendor-recent-orders-table/columns";
import {
  formatOrderCount,
  formatSelectedOrderCount,
  preventPaginationNavigation,
} from "./vendor-recent-orders-table/formatters";
import { type OrderFilter, type VendorOrderRow, orderFilters } from "./vendor-recent-orders-table/schema";

interface VendorRecentOrdersProps {
  orders: VendorOrderRow[];
}

export function VendorRecentOrders({ orders }: VendorRecentOrdersProps) {
  ...
  const table = useReactTable({
    data: orders,
    columns: vendorRecentOrdersColumns,
    state: {
      rowSelection,
      sorting,
      columnFilters,
